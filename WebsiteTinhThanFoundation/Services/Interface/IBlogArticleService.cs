...
namespace WebsiteTinhThanFoundation.Services.Interface
{
    public interface IBlogArticleService
    {
        ...
        public Task<ICollection<BlogArticle>> GetAllAsync(string? keyword = null, string? tag = null, Func<IQueryable<BlogArticle>, IIncludableQueryable<BlogArticle, object>>? includes = null, bool? isActive = null);
